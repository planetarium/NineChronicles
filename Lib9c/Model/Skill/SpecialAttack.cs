...
namespace Nekoyume.Model.Skill
{
    ...
    {
        public SpecialAttack(SkillSheet.Row skillRow, int power, int chance) : base(skillRow, power, chance)
        {
        }
            ...
            IEnumerable<Buff.Buff> buffs)
        {
            ...
            return new Model.BattleStatus.SpecialAttack(clone, SkillRow.Id, damage, buff);
        }
    }
}
