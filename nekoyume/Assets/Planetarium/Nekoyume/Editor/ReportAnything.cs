...
namespace Planetarium.Nekoyume.Editor
{
    public static class ReportAnything
    {
        ...
        {
            NcDebugger.Log("[Report Anything] Start report: \"Check the shop items is made with mimisbrunnr recipe\"");
            ...
            NcDebugger.Log("[Report Anything] End report");
        }
