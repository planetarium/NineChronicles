...
namespace Tests.EditMode
{
    public class CombinationEquipmentTest
    {
        ...
        public void SelectSingleOption()
        {
            ...
            row.Set(new List<string>
            {
                "1", "3", "1", "1", "306040", "3", "306023", "2", "306024", "1", "1", "0.5", "4", "0.3", "2", "0.2",
                "", "", "1"
            });
            var equipment = (Equipment) ItemFactory.CreateItemUsable(
                _tableSheets.EquipmentItemSheet.Values.First(),
            ...
            Assert.IsTrue(equipment.GetOptionCount() == 1);
        }
        ...
        public void SelectMultipleOption()
        {
            ...
            row.Set(new List<string>
            {
                "1", "3", "1", "1", "306040", "3", "306023", "2", "306024", "1", "1", "0.2", "4", "0.5", "2", "0.3",
                "", "", "2"
            });
            var equipment = (Equipment) ItemFactory.CreateItemUsable(
                _tableSheets.EquipmentItemSheet.Values.First(),
            ...
            var optionIds = CombinationEquipment.SelectOption(_tableSheets, row, new Cheat.DebugRandom(), equipment);
            Assert.IsNotEmpty(optionIds);
            Assert.IsTrue(equipment.GetOptionCount() == 2);
        }
    }
}
