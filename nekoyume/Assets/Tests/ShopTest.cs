...
//            }
            ...
            yield return new WaitUntil(() => Game.instance.agentController.Transactions.Count == 2);
            var sellTx = Game.instance.agentController.Transactions.Values.OrderByDescending(t => t.Timestamp).First();
            ...
            yield return new WaitUntil(() => Game.instance.agentController.Transactions.Count == 3);
            var cancelTx = Game.instance.agentController.Transactions.Values.OrderByDescending(t => t.Timestamp).First();
        ...
        public IEnumerator Buy()
        {
            ...
            loginDetail.CreateClick();
            yield return new WaitUntil(() => Game.instance.agentController.Transactions.Any());
            var createAvatarTx = Game.instance.agentController.Transactions.Values.First();
            yield return miner.CoMine(createAvatarTx);
            yield return new WaitWhile(() => States.Instance.currentAvatarState.Value is null);
...
//            }
            ...
            yield return new WaitUntil(() => Game.instance.agentController.Transactions.Count == 3);
            Debug.Log(10);
            var invalidTx = Game.instance.agentController.Transactions.Values.OrderByDescending(t => t.Timestamp).First();
