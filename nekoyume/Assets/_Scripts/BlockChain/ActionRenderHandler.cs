...
namespace Nekoyume.BlockChain
{
    ...
    public class ActionRenderHandler : ActionHandler
    {
        ...
        private void ResponseCombinationEquipment(ActionBase.ActionEvaluation<CombinationEquipment> eval)
        {
            ...
            var resultAddress = eval.Action.ResultAddress;
            var result = new Combination.ResultModel((Dictionary) eval.OutputStates.GetState(resultAddress));
            ...
            LocalStateModifier.AddNewAttachmentMail(avatarAddress, result.mailId);
        ...
        private void ResponseBuy(ActionBase.ActionEvaluation<Buy> eval)
        {
            ...
            if (buyerAvatarAddress == States.Instance.CurrentAvatarState.address)
            {
                ...
                LocalStateModifier.AddNewAttachmentMail(buyerAvatarAddress, result.mailId);
            ...
            else
            {
                ...
                LocalStateModifier.AddNewAttachmentMail(sellerAvatarAddress, result.mailId);
