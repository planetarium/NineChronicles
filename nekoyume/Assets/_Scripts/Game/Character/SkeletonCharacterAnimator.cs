...
namespace Nekoyume.Game.Character
{
    public class SkeletonCharacterAnimator : MecanimCharacterAnimator
    {
        ...
        private void ColorTween()
        {
            ...
            _colorTweenSequence.Append(DOTween.To(() => ColorTweenFrom, value => mat.SetFloat("_FillPhase", value), ColorTweenTo, ColorTweenDuration));
            _colorTweenSequence.Append(DOTween.To(() => ColorTweenTo, value => mat.SetFloat("_FillPhase", value), ColorTweenFrom, ColorTweenDuration));
