...
{
    // Until the unlock world loading animation is developed, this code must be synchronized with the DataLoadingScreen.
    public class UnlockWorldLoadingScreen : ScreenWidget
    {
