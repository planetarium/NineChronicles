...
{
    // Until the world map movement animation is developed, this code must be synchronized with the DataLoadingScreen.
    public class WorldMapLoadingScreen : ScreenWidget
    {
