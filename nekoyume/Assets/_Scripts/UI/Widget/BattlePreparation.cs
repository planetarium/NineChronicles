...
namespace Nekoyume.UI
{
    ...
    public class BattlePreparation : Widget
    {
        ...
        protected override void Awake()
        {
            ...
            BattleRenderManager.Instance.OnStageStart += GoToStage;
        }
        ...
        public override void Initialize()
        {
            ...
            boostPopupButton.OnClickAsObservable()
                .Where(_ => EnoughToPlay && !BattleRenderManager.Instance.IsOnBattle)
                .Subscribe(_ => ShowBoosterPopup());

            boostPopupButton.OnClickAsObservable().Where(_ => !EnoughToPlay && !BattleRenderManager.Instance.IsOnBattle)
                .ThrottleFirst(TimeSpan.FromSeconds(1f))
                .Subscribe(_ =>
                    OneLineSystem.Push(
                        MailType.System,
