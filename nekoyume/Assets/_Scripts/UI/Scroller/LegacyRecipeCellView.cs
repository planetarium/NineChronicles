...
namespace Nekoyume.UI.Scroller
{
    ...
    public class LegacyRecipeCellView : EnhancedScrollerCellView
    {
        public interface IEventListener
        {
            void OnRecipeCellViewStarClick(LegacyRecipeCellView recipeCellView);
            void OnRecipeCellViewSubmitClick(LegacyRecipeCellView recipeCellView);
        }
