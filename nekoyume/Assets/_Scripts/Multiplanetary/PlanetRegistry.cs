...
namespace Nekoyume.Multiplanetary
{
    public class PlanetRegistry
    {
            ...
            bool shuffleOrderOfPlanetInfos = true)
        {
            ...
            NcDebugger.Log("[PlanetRegistry] start initialization");
            ...
            catch (OperationCanceledException ex)
            {
                ...
                {
                    NcDebugger.LogError($"[PlanetRegistry] initialize failed due to timeout({timeout})");
                    return false;
                }
            }
            ...
            {
                NcDebugger.LogError($"[PlanetRegistry] initialize failed: {req.error}");
                return false;
            }
            ...
            if (planetInfos is not null)
            {
                ...
                {
                    NcDebugger.LogError("[PlanetRegistry] initialize failed: count of planet infos is 0.");
                    return false;
                }
                ...
                NcDebugger.Log($"[PlanetRegistry] initialize succeeded: [{text}]");

                IsInitialized = true;
            }

            NcDebugger.Log($"[PlanetRegistry] finish initialization: {IsInitialized}");
